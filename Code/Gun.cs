...
public class Gun : MonoBehaviour {
    ...
    private static int savedWeaponIndex;
    private static float savedCooldown;
    ...
    */
    ...
    public void Start()
    {
        ...
        savedWeaponIndex = currentWeaponIndex;
        savedCooldown = FireCooldown;
    ...
    private void OnLevelWasLoaded(int level)
    {
        ...
        if(level == CurrentScene){
            ...
            currentWeaponIndex = savedWeaponIndex;
            FireCooldown = savedCooldown;
