...
*/
    ...
    void Update()
    {
        ...
        if ((grounded || !doubleJump) && ((Input.GetKeyDown(KeyCode.W) && wasInverted == false && !paused) || (Input.GetKeyDown(KeyCode.S) && wasInverted == true && !paused)))
        {
        ...
        else if(!usedRocket && (grounded || !doubleJump) && hasRocketBoost && Input.GetKeyDown(KeyCode.Space) && currentFuel > 0 && !paused)
        {
            anim.SetInteger("State", 2);
            rb2d.velocity = new Vector2(rb2d.velocity.x, 0f);
        ...
        if ((Input.GetKeyDown(KeyCode.Tab) && hasGravityBoots && !paused) ||  (infiniteGrav && Input.GetKeyDown(KeyCode.Tab) && hasGravityBoots && !paused))
        {
